...
$(document).ready(() => {
    ...
    <div class="col-md-8 pt-4">
        ...
        <div class="buttons">
            <button id="sourceBtn"><a class="text-decoration-none text-white" href="${list[i].strSource}">Source</a></button>
            <button id="youtubeBtn"><a class="text-decoration-none text-white" href="${list[i].strYoutube}">Youtube</a></button>
        </div>
    </div>`
        }
        ...
        for (let i = 0; i < list.length; i++) {
            ...
            <div data-area="${list[i].strArea}" class="areaCard inner overflow-hidden rounded-2">
                <div data-area="${list[i].strArea}" class="image text-center">
                    <img data-area="${list[i].strArea}" src="./images/area.png" class="w-50 m-auto" alt="">
        ...
        for (let i = 0; i < 20; i++) {
            ...
            <div data-ingredient="${list[i].strIngredient}" class="inner overflow-hidden rounded-2">
                <div data-ingredient="${list[i].strIngredient}" class="image text-center">
                    <img data-ingredient="${list[i].strIngredient}" src="./images/ingredients.png" class="w-50 m-auto" alt="">
